...
class AppConstants {
  static const String appName = 'The Delivery Driver App';
  static const double appVersion = 3.9; ///Flutter sdk 3.27.1

  static const String baseUrl = 'https://thedelivery.co.za';
