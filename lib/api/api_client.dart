...
class ApiClient extends GetxService {
  ...
  Response handleResponse(
    ...
    final String? responseMessage = ResponseMessageHelper.extractFromBody(
      body ?? response.body,
    ...
    Response response0 = Response(
      ...
      statusText: response.statusCode == 200
          ? response.reasonPhrase
          : responseMessage ?? response.reasonPhrase,
    );
    if (response0.statusCode != 200 &&
        (response0.statusText == null ||
            response0.statusText!.trim().isEmpty)) {
      response0 = Response(
        body: response0.body,
