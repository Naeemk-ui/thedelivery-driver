...
class _DeliveryManRegistrationScreenState
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              _documentPicker(
                                ...
                                file: authController.pickedDrivingLicense,
                              ),
                              const SizedBox(
                              ...
                              _documentPicker(
                                ...
                                file: authController.pickedProofOfAddress,
                              ),
                              const SizedBox(
                                  height: Dimensions.paddingSizeSmall),
                              _documentPicker(
                                ...
                                title: 'Bank confirmation (optional now)',
                                file: authController.pickedBankConfirmation,
                              ),
                              Padding(
                                padding: const EdgeInsets.only(
                                    top: Dimensions.paddingSizeSmall),
                                child: Text(
                                  'Your account activates after the first two documents are uploaded. Withdrawals remain locked until bank confirmation is verified.',
                                  style: robotoRegular.copyWith(
                              ...
                              CheckboxListTile(
                                ...
                                title: const Text(
                                  'I consent to secure automated verification of my registration documents. Only limited, redacted document text may be sent to an external verification provider.',
                                ),
                              ),
                              const SizedBox(
                                  height: Dimensions.paddingSizeSmall),
  ...
  void _addDeliveryMan(AuthController authController,
    ...
    } else if (authController.pickedDrivingLicense == null) {
      showCustomSnackBar('Please upload your driving licence.');
    } else if (authController.pickedProofOfAddress == null) {
      showCustomSnackBar('Please upload your proof of address.');
    } else if (!_verificationConsent) {
      showCustomSnackBar(
          'Please consent to document verification before continuing.');
    } else {
  ...
  Widget _documentPicker(
    ...
    return InkWell(
      onTap: () => authController.pickOnboardingDocument(type),
      child: DottedBorder(
        color: Theme.of(context).primaryColor,
        strokeWidth: 1,
        dashPattern: const [5, 5],
        ...
        child: SizedBox(
          ...
          child: file == null
              ? Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Tap to choose a clear photo',
                      style: robotoRegular.copyWith(
                          color: Theme.of(context).disabledColor)),
                ])
              : Row(children: [
                  ...
                  IconButton(
                    onPressed: () =>
                        authController.removeOnboardingDocument(type),
